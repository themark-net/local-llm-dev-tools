...
| **MLX + MLX-LM** | Inference & Serving | https://github.com/ml-explore/mlx (mlx-lm) | 80 | 92 | 78 | 80 | 82 | A | #apple-silicon #high-perf #quantizedd #local-first | Best-in-class on Apple Silicon (M-series). Fast unified memory, 4/8-bit native. mlx-lm provides server. Excellent for Mac-based dev pipelines. Tool calling via adapters. |
...
*v0.4.5 — Entry 068 (8 exits taxonomy) folded into Finn Loop / eval-loop patterns; scores raised to reflect completeness.*
